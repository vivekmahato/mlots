...
class MINIROCKET:
    ...
    def __init__(self, num_kernels=10_000, max_dilations_per_kernel=32, random_seed=1992):
    ...
    def fit(self, X=None):
        ...
        self.parameters = _fit(X, num_features=self.num_kernels,
    ...
    def transform(self, X=None):
        ...
        X = X.reshape((X.shape[0], 1, X.shape[1]))
        X = X[:, 0, :].astype(np.float32)
        return _transform(X, self.parameters)
